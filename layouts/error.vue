...
<div class="container">
  <div class="boo-wrapper">
    ...
    <p>
      ...
      <br />
      вернуться на <nuxt-link to="/">главную страницу</nuxt-link>?
    </p>
  </div>
</div>
</template>
...
export default {
  ...
  head () {
    return {
      title: 'Ошибка',
      meta: [
        { hid: 'description', name: 'description', content: 'Автономные кассы и фискальные регистраторы онлайн купить в Краснодаре' }
      ]
    }
  }
